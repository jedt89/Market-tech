...
import header02Mobile from './img/header-02-mobile.png';
import header03 from './img/header-03.png';
import header03Mobile from './img/header-03-mobile.png';
import header04 from './img/header-04.png';
import header04Mobile from './img/header-04-mobile.png';
import header05 from './img/header-05.png';
import header05Mobile from './img/header-05-mobile.png';
import header06 from './img/header-06.png';
import header06Mobile from './img/header-06-mobile.png';
...
import videoCardIcon from './icons/video-card-icon.png';
import powerSupplyIcon from './icons/power-supply-icon.png';
import hddIcon from './icons/hdd-icon.png';
